...
const checks = [
  ...
  ['Qwen product helper explains visible metadata filling', dashboard, 'Qwen fills missing metadata, tags, folders, and search hints from OCR. Locked manual fields are preserved.'],
  ['Qwen field source badge supports evidence tooltip', dashboard, 'title={info.evidence || undefined}'],
  ['primary action is process all', dashboard, 'Process All Documents'],
  ['stage-only actions are advanced', dashboard, 'Advanced stage-only actions'],
  ['dashboard selected delete confirmation exists', dashboard, 'Delete selected'],
  ['upload does not auto-navigate to record', dashboard, 'Select a file to inspect OCR and metadata.'],
  ...
  ['Fast OCR option is visible', dashboard, 'Fast OCR · PP-OCRv6 medium'],
  ...
  ['Documents page exposes delete selected action', documentsPage, 'Delete selected'],
  ...
  ['Collections page exposes create collection action', collectionsPage, 'Create collection'],
  ['Collections page calls createCollection API', collectionsPage, 'api.createCollection'],
  ['Schemas page exposes create collection action', schemaPage, 'Create collection'],
  ...
  ['Admin page has dark scoped page class', adminPage, 'className="admin-page"'],
  ...
  ['Dark admin overrides are present', styles, '.admin-page input'],
